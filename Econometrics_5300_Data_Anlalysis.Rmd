...
TrendsAppendedDf <- rbind(TrendsUpToInter_1_Raw, TrendsUpToInter_2_Raw, TrendsUpToInter_3_Raw, TrendsUpToInter_4_Raw, TrendsUpToInter_5_Raw, TrendsUpToInter_6_Raw)
TrendsAppendedNA <- map(TrendsAppendedDf, ~mean(is.na(.)))
TrendsAppendedNA
```

No particularly significant missing data. We'll want to check for this by school though to see if there are any obvious outlines we should should remove. 
